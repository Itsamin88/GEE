...
DESC = {
 ...
 'restoration_signal_flag': ('TRUE when that proxy is at or above 10%. A prompt for documentary follow-up on a shortlist, not an exclusion by default.', 'both'),
 ...
 'n_patches_found': ('How many built-up patches the detector found in the 5-100 km ring before any criterion was applied. A low number here explains a thin block.', 'both'),
 'n_candidates_screened': ('How many of those survived the cheap gates and were measured in full.', 'both'),
 'ladder_step': ('The worst tier in this settlement\'s block: 1 all controls close, 2 the search was extended or a tolerance missed, 3 best available.', 'both'),
 'quartet_grade': ('That same tier, in words. The plan\'s three-tier quartet grading.', 'both'),
